...
import { display, space, width, flex, textAlign, alignSelf, order, get, variant } from 'styled-system';
...
}, buttonSize, display, space, width, flex, textAlign, alignSelf, order);

Button.propTypes = _extends({
  disabled: PropTypes.bool
}, systemPropTypes.buttonStyle, systemPropTypes.display, systemPropTypes.space, systemPropTypes.width, systemPropTypes.flex, systemPropTypes.textAlign, systemPropTypes.alignSelf, systemPropTypes.order, {
