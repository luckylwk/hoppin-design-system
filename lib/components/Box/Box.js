...
var Box = (0, _styledComponents2.default)('div')({
  ...
  minWidth: 0
}, _styledSystem.space, _styledSystem.layout, _styledSystem.flex, _styledSystem.flexGrow, _styledSystem.flexShrink, _styledSystem.flexBasis, _styledSystem.justifySelf, _styledSystem.alignSelf, _styledSystem.order, _styledSystem.color, _styledSystem.border, _styledSystem.textAlign, _styledSystem.size, _styledSystem.position);
