...
var MobileImage = (0, _styledComponents["default"])(_Box.Box)(_templateObject(), function (_ref) {
...
var StepContainer = (0, _styledComponents["default"])(_Flex.Flex)(_templateObject2(), function (props) {
...
var StepBullet = (0, _styledComponents["default"])(_Flex.Flex)(_templateObject3(), function (props) {
...
var ActiveStepBox = (0, _styledComponents["default"])(_Box.Box)(_templateObject4(), function (props) {
...
var StepContent = (0, _styledComponents["default"])(_Box.Box)(_templateObject5(), function (props) {
  return props.isActive && props.showTrack ? props.theme.space[3] : 0;
});
StepContent.displayName = 'StepContent';
var StepTitle = (0, _styledComponents["default"])(_Heading.Heading)(_templateObject6(), function (props) {
...
function Step(_ref2) {
  ...
  var ContentWrapper = isActive && showTrack ? ActiveStepBox : _Box.Box;
  return /*#__PURE__*/_react["default"].createElement(StepContainer, _extends({
    index: index,
    isActive: isActive,
    isLast: isLast,
    bulletSize: bulletSize,
    showTrack: showTrack
  }, rest), /*#__PURE__*/_react["default"].createElement(StepBullet, {
    index: index,
    isActive: isActive,
    bulletSize: bulletSize,
    showTrack: showTrack
  }, /*#__PURE__*/_react["default"].createElement("span", null, bullet)), /*#__PURE__*/_react["default"].createElement(ContentWrapper, null, isActive && image && /*#__PURE__*/_react["default"].createElement(MobileImage, {
    image: image,
    display: ['block', 'block', hideStepImageOnDesktop ? 'none' : 'block']
  }), /*#__PURE__*/_react["default"].createElement(StepContent, {
    isActive: isActive,
    showTrack: showTrack
  }, /*#__PURE__*/_react["default"].createElement(StepTitle, {
    as: "h3",
    isActive: isActive,
    isLast: isLast,
  ...
  }, title), isActive && /*#__PURE__*/_react["default"].createElement(_Text.Text, {
    display: "block",
    color: showTrack ? 'neutral.darker' : 'inherit'
  }, description), interactive && isActive && !isLast && /*#__PURE__*/_react["default"].createElement(_Button.Button, {
    onClick: function onClick(e) {
      e.preventDefault();
      goToStep(index + 1);
    },
    mt: 2
  }, nextLabel))), isActive && /*#__PURE__*/_react["default"].createElement(_Box.Box, {
    flexGrow: "2"
  }));
}
