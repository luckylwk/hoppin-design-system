...
var Loader = function Loader(_ref5) {
  ...
  return _react2.default.createElement(
    Wrapper,
    null,
    _react2.default.createElement(Dot, { delay: '-0.32s', size: size, context: context }),
    _react2.default.createElement(Dot, { delay: '-0.16s', size: size, context: context }),
    _react2.default.createElement(Dot, { delay: '0.0s', size: size, context: context })
  );
};
