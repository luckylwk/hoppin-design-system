...
var BounceWrapper = _styledComponents2.default.div(_templateObject2, function (props) {
  return props.size;
});

var Bounce = _styledComponents2.default.div(_templateObject3, function (props) {
  return props.size;
}, function (props) {
  return props.size;
}, function (props) {
...
var BounceLoader = function BounceLoader(_ref2) {
  ...
  return _react2.default.createElement(
    BounceWrapper,
    { size: size },
    _react2.default.createElement(Bounce, { delay: '0s', type: type, size: size }),
    _react2.default.createElement(Bounce, { delay: '-1s', type: type, size: size })
  );
};
