...
var Button = _styledComponents2.default.button(_templateObject, function (_ref) {
  ...
  var colors = (0, _styledSystem.get)(theme, 'colors.' + context, '#333');
...
}, buttonSize, _styledSystem.display, _styledSystem.space, _styledSystem.width, _styledSystem.flex, _styledSystem.textAlign, _styledSystem.alignSelf, _styledSystem.order);

Button.propTypes = _extends({
  disabled: _propTypes2.default.bool
}, _propTypes4.default.buttonStyle, _propTypes4.default.display, _propTypes4.default.space, _propTypes4.default.width, _propTypes4.default.flex, _propTypes4.default.textAlign, _propTypes4.default.alignSelf, _propTypes4.default.order, {
