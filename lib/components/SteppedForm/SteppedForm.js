...
var SteppedForm = /*#__PURE__*/function (_Component) {
  ...
  function SteppedForm(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "_getNextStep", function (step) {
      ...
      var index = (0, _findIndex2["default"])(steps, {
        slug: step.slug
      });
    ...
    _defineProperty(_assertThisInitialized(_this), "_getProgress", function () {
      ...
      var index = stepShowing ? (0, _findIndex2["default"])(steps, {
    ...
    _defineProperty(_assertThisInitialized(_this), "handleNavigate", /*#__PURE__*/function () {
      var _ref2 = _asyncToGenerator( /*#__PURE__*/_regenerator["default"].mark(function _callee2(action) {
    ...
    _defineProperty(_assertThisInitialized(_this), "_replaceTemplateVarsIfNeeded", function (string) {
      if (string.indexOf('${') < 0) {
        ...
        var compiledTemplate = (0, _template2["default"])(string);
    ...
    var _formData = (0, _merge2["default"])(_emptyFormData, initialFormData);
  ...
  _proto.componentDidUpdate = function componentDidUpdate(prevProps) {
    ...
    if (prevProps.formData !== formData) {
      var updatedFormData = (0, _merge2["default"])(this.state.formData, formData);
      this.setState({
        formData: updatedFormData
      });
    }
  ...
  _proto.render = function render() {
    ...
    switch (stepShowing.type) {
      case 'form':
        ...
        StepComponent = /*#__PURE__*/_react["default"].createElement(_index.StepForm, _extends({}, stepShowing, {
      ...
      case 'multiple-choice':
        StepComponent = /*#__PURE__*/_react["default"].createElement(_index.StepMultipleChoice, _extends({}, stepShowing, {
      ...
      case 'timeline':
        StepComponent = /*#__PURE__*/_react["default"].createElement(_index.StepTimeline, _extends({}, stepShowing, {
          onNavigate: this.handleNavigate
        }));
        break;

      case 'custom':
        StepComponent = /*#__PURE__*/_react["default"].createElement(_index.StepCustom, _extends({}, stepShowing, {
          onNavigate: this.finishSlide,
          formData: formData,
          onChange: this.handleFieldChange,
          validationErrors: validationErrors[stepShowing.slug] || [],
      ...
      case 'md':
      default:
        StepComponent = /*#__PURE__*/_react["default"].createElement(_index.StepMd, _extends({}, stepShowing, {
          onNavigate: this.finishSlide,
          displayMode: displayMode
        }));
    }

    return /*#__PURE__*/_react["default"].createElement(_react.Fragment, null, /*#__PURE__*/_react["default"].createElement(_Progress.ProgressBar, {
    ...
    }, /*#__PURE__*/_react["default"].createElement(_index.FullScreenStepWrapper, {
...
var _default = (0, _reactRouterDom.withRouter)(SteppedForm);
