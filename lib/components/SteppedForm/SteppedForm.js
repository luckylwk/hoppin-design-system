...
var SteppedForm = (_temp = _class = function (_Component) {
  ...
  function SteppedForm(props) {
    ...
    var formData = (0, _merge3.default)(emptyFormData, initialFormData);
  ...
  SteppedForm.prototype.componentDidUpdate = function componentDidUpdate(prevProps) {
    ...
    if (prevProps.formData !== formData) {
      var updatedFormData = (0, _merge3.default)(this.state.formData, formData);
  ...
  SteppedForm.prototype.render = function render() {
    ...
    var StepComponent = _Loader.Loader;
    ...
    switch (stepShowing.type) {
      case 'form':
        ...
        StepComponent = _react2.default.createElement(_index.StepForm, _extends({}, stepShowing, { fields: fieldsWithData }, {
      ...
      case 'multiple-choice':
        StepComponent = _react2.default.createElement(_index.StepMultipleChoice, _extends({}, stepShowing, {
        ...
        break;
      case 'timeline':
        StepComponent = _react2.default.createElement(_index.StepTimeline, _extends({}, stepShowing, { onNavigate: this.handleNavigate }));
        break;
      case 'custom':
        StepComponent = _react2.default.createElement(_index.StepCustom, _extends({}, stepShowing, {
          onNavigate: this.finishSlide,
          formData: formData,
          onChange: this.handleFieldChange,
          validationErrors: validationErrors[stepShowing.slug] || [],
      ...
      case 'md':
      default:
        StepComponent = _react2.default.createElement(_index.StepMd, _extends({}, stepShowing, {
          onNavigate: this.finishSlide,
          displayMode: displayMode
        }));
    }
    ...
    return _react2.default.createElement(
      _react.Fragment,
      null,
      _react2.default.createElement(_Progress.ProgressBar, { percent: this._getProgress() }),
  ...
  this._getNextStep = function () {
    ...
    var index = (0, _findIndex3.default)(steps, { slug: step.slug });
  ...
  this._getStepBySlug = function (slug) {
    ...
    var index = (0, _findIndex3.default)(steps, { slug: slug });
    var notFound = index === -1;
  ...
  this._getProgress = function () {
    ...
    var index = stepShowing ? (0, _findIndex3.default)(steps, { slug: stepShowing.slug }) + 1 : 0;
  ...
  this._getStepFromSlug = function (stepSlug) {
    ...
    var index = (0, _findIndex3.default)(steps, { slug: stepSlug });
    var notFound = index === -1;
  ...
  this.handleNavigate = function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/_regenerator2.default.mark(function _callee2(action) {
  ...
  this._replaceTemplateVarsIfNeeded = function (string) {
    if (string.indexOf('${') < 0) {
      ...
      var compiledTemplate = (0, _template3.default)(string);
...
exports.default = (0, _reactRouterDom.withRouter)(SteppedForm);
