...
exports.convertHTMLToText = undefined;
...
var convertHTMLToText = exports.convertHTMLToText = function convertHTMLToText(html) {
...
var Wrapper = (0, _styledComponents2.default)(_Box.Box)(_templateObject);

var EditorWrapper = (0, _styledComponents2.default)(_Box.Box)(_templateObject2, function (_ref) {
...
var TextAreaDraftJS = function (_Component) {
  ...
  function TextAreaDraftJS(props) {
    ...
    _this._onChange = function (editorState) {
      ...
      var jsonContent = (0, _draftJs.convertToRaw)(contentState);
    ...
    var state = void 0;
    if (!isEmpty) {
      var blocksFromHTML = (0, _draftJs.convertFromHTML)(props.value);
      if (blocksFromHTML.contentBlocks) {
        state = _draftJs.ContentState.createFromBlockArray(blocksFromHTML.contentBlocks, blocksFromHTML.entityMap);
      } else {
        isEmpty = true;
      }
    }
    ...
    _this.state = {
      ...
      empty: isEmpty,
      // Immutable record...
      editorState: isEmpty ? _draftJs.EditorState.createEmpty() : _draftJs.EditorState.createWithContent(state)
    };
...
exports.default = TextAreaDraftJS;