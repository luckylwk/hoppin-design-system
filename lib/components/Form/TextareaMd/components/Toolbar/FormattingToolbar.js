    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, _React$Component.call.apply(_React$Component, [this].concat(args))), _this), _this.hasMark = function (type) {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(ButtonIcon, { color: _this.props.theme.colors.whiteout.lightest })
        )
      );
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(IconClass, { color: _this.props.theme.colors.whiteout.lightest })
        )
      );
...
var markButtonDetails = {
  bold: { Icon: _fi.FiBold, label: 'Bold' },
  italic: { Icon: _fi.FiItalic, label: 'Italic' },
  deleted: { Icon: _fi.FiDelete, label: 'Deleted' },
  code: { Icon: _fi.FiCode, label: 'Code' }
};
