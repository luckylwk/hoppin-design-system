...
var TextareaMdField = (_temp = _class = function (_React$Component) {
  ...
  function TextareaMdField(props) {
    ...
    _this.plugins = [_Nodes2.default, _Marks2.default, (0, _KeyboardBehaviour2.default)(), (0, _KeyboardShortcuts2.default)(), (0, _MarkdownShortcuts2.default)(), (0, _MarkdownPaste2.default)(_this.markdown), (0, _Ellipsis2.default)(), (0, _Chrome2.default)()];
...
var StyledEditor = (0, _styledComponents2.default)(_slateReact.Editor)(_templateObject, _styledSystem.space, _styledSystem.layout, _styledSystem.flexbox, _styledSystem.fontSize, function (props) {
