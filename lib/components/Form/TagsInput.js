...
var Item = _styledComponents2.default.li(_templateObject2, function (props) {
      ...
      _react2.default.createElement(
        ...
        this.state.items.map(function (email, ix) {
          return _react2.default.createElement(
            ...
            email,
            _react2.default.createElement(_fi.FiX, {
              size: 12,
              style: {
                marginLeft: '0.1rem',
                position: 'relative',
...
TagInput.propTypes = process.env.NODE_ENV !== "production" ? {
  ...
  handleChangeToItems: _propTypes2.default.func
} : {};
