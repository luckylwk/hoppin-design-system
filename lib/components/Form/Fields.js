...
var FiChevronDownStyled = (0, _styledComponents2.default)(_fi.FiChevronDown)(_templateObject, function (_ref) {
  var theme = _ref.theme,
      focused = _ref.focused;
  return focused === 'true' ? theme.colors.primary.dark : theme.colors.neutral.base;
});

var FiSearchStyled = (0, _styledComponents2.default)(_fi.FiSearch)(_templateObject, function (_ref2) {
...
var DropdownIndicator = function DropdownIndicator(props) {
  return _react2.default.createElement(
    _reactSelect.components.DropdownIndicator,
    props,
    _react2.default.createElement(FiChevronDownStyled, { focused: '' + props.isFocused })
  );
};
...
var renderField = exports.renderField = function renderField(field, _onChange, selectStyling) {
  ...
  if (field.type === 'single-select-button' || field.type === 'select-button') {
    return _react2.default.createElement(
      _react.Fragment,
      null,
      _react2.default.createElement(_.SelectButton, {
        name: field.name,
        options: field.options,
        value: field.value,
        onChange: _onChange.bind(null, field.name),
