...
exports.colors = colors = _extends({}, colors, {
  form: {
    background: colors.whiteout.lighter,
    border: colors.whiteout.darkest,
    placeholder: (0, _color["default"])(colors.neutral.darker).alpha('0.65').rgb().string(),
    required: (0, _color["default"])(colors.orange).alpha('0.75').rgb().string(),
    focused: {
